...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The test_scanPricePromotion recording.
    /// </summary>
    [TestModule("4ff17e62-9e81-4ed5-913a-c3828cd9364a", ModuleType.Recording, 1)]
    public partial class test_scanPricePromotion : ITestModule
    {
        /// <summary>
        ...
        static test_scanPricePromotion instance = new test_scanPricePromotion();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public test_scanPricePromotion()
        {
            BarCodeMessage = "";
        }
        ...
        /// </summary>
        public static test_scanPricePromotion Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("7312f11c-5466-478d-a462-4763d0faf7d6")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='Diet Coke 330ml 18pk') on item 'NCRNEXTGENUI2.ItemDescription'.", repo.NCRNEXTGENUI2.ItemDescriptionInfo, new RecordItemIndex(8));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='€10.00') on item 'NCRNEXTGENUI2.CartControl.DueAmountValue'.", repo.NCRNEXTGENUI2.CartControl.DueAmountValueInfo, new RecordItemIndex(12));
            Validate.AttributeEqual(repo.NCRNEXTGENUI2.CartControl.DueAmountValueInfo, "Text", "€10.00");
            Delay.Milliseconds(100);
            
            //Report.Log(ReportLevel.Info, "Delay", "Waiting for 300ms.", new RecordItemIndex(13));
            //Delay.Duration(300, false);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'NCRNEXTGENUI2.List2Button' at Center.", repo.NCRNEXTGENUI2.List2ButtonInfo, new RecordItemIndex(14));
            //repo.NCRNEXTGENUI2.List2Button.Click();
            //Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'NCRNEXTGENUI2.Tender4' at Center.", repo.NCRNEXTGENUI2.Tender4Info, new RecordItemIndex(15));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='Thanks for shopping with us.') on item 'NCRNEXTGENUI2.HeaderText'.", repo.NCRNEXTGENUI2.HeaderTextInfo, new RecordItemIndex(17));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='Press Here or           Scan Item') on item 'NCRNEXTGENUI2.PressHereOrScanItem'.", repo.NCRNEXTGENUI2.PressHereOrScanItemInfo, new RecordItemIndex(19));
