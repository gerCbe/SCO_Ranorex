...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The test_scanLinkDealBogof recording.
    /// </summary>
    [TestModule("7591efcb-ec59-4516-bfb7-5c6d3d6fc3e7", ModuleType.Recording, 1)]
    public partial class test_scanLinkDealBogof : ITestModule
    {
        /// <summary>
        ...
        static test_scanLinkDealBogof instance = new test_scanLinkDealBogof();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public test_scanLinkDealBogof()
        {
            BarCodeMessage = "";
        }
        ...
        /// </summary>
        public static test_scanLinkDealBogof Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("43e9a49b-7df7-4f6c-a8a2-69d17d45a265")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='Sprite (500ml)') on item 'NCRNEXTGENUI2.ItemDescription'.", repo.NCRNEXTGENUI2.ItemDescriptionInfo, new RecordItemIndex(8));
            Validate.AttributeEqual(repo.NCRNEXTGENUI2.ItemDescriptionInfo, "Text", "Sprite (500ml)");
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='-€2.09') on item 'NCRNEXTGENUI2.CartControl.ItemPrice'.", repo.NCRNEXTGENUI2.CartControl.ItemPriceInfo, new RecordItemIndex(10));
            Validate.AttributeEqual(repo.NCRNEXTGENUI2.CartControl.ItemPriceInfo, "Text", "-€2.09");
            Delay.Milliseconds(100);
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='-€2.09') on item 'NCRNEXTGENUI2.CartControl.ItemPrice1'.", repo.NCRNEXTGENUI2.CartControl.ItemPrice1Info, new RecordItemIndex(12));
            Validate.AttributeEqual(repo.NCRNEXTGENUI2.CartControl.ItemPrice1Info, "Text", "-€2.09");
            Delay.Milliseconds(100);
